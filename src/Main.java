...
class Main {
    ...
    public static void printSubMenu(String category) {
        if (category.equalsIgnoreCase("Burgers")) {
            ...
            System.out.println("\n" + category.toUpperCase());
            for (int i = 0; i < frozenCustardMenu.length; i++) {
                System.out.println((i + 1) + ". " + frozenCustardMenu[i]);
            }
            System.out.println("-------------------------------");
            System.out.print("선택: ");
            ...
            System.out.println("\n" + category.toUpperCase());
            for (int i = 0; i < beerMenu.length; i++) {
                System.out.println((i + 1) + ". " + beerMenu[i]);
            }
            System.out.println("-------------------------------");
            System.out.print("선택: ");
        } else {
